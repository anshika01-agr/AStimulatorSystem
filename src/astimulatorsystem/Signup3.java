...
public class Signup3 extends JFrame implements ActionListener {
    ...
    Signup3() {
        ...
        l6 = new JLabel("It would appear on ATM Card/Cheque Book ans Statement");
        ...
        c7 = new JCheckBox("I hereby declares that the above enetred details correct to the best of my knowledge.",true);
        ...
        l4.setBounds(350,260,250,30);
        add(l4);
        
        l5.setBounds(100,295,200,20);
        add(l5);
        
        l6.setBounds(350,295,500,20);
        add(l6);
        
        l7.setBounds(100,330,200,30);
        add(l7);
        
        l8.setBounds(350,330,200,30);
        add(l8);
        
        l9.setBounds(100,360,200,30);
        add(l9);
       
        l10.setBounds(100,405,200,30);
        add(l10);
        
        c1.setBounds(100,448,200,30);
        add(c1);
        
        c2.setBounds(350,448,200,30);
        add(c2);
        
        c3.setBounds(100,486,200,30);
        add(c3);
        
        c4.setBounds(350,486,200,30);
        add(c4);
        
        c5.setBounds(100,524,200,30);
        add(c5);
        
        c6.setBounds(350,524,200,30);
        add(c6);
