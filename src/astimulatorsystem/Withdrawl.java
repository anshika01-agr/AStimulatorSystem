...
import astimulatorsystem.Transcations;
import astimulatorsystem.conn;
import java.awt.*;
...
public class Withdrawl extends JFrame implements ActionListener{
    ...
    JLabel l1,l2,l3,l4;
     ...
     Withdrawl() {
        ...
        l1.setBounds(150,118,800,60);
        add(l1);
        
        l2.setBounds(270,165,800,60);
        add(l2);
        
        t1.setBounds(210,340,360,50);
        add(t1);
        
        b1.setBounds(220,435,160,50);
        add(b1);
        
        b2.setBounds(400,435,160,50);
        add(b2);
